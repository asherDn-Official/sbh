...
export const metadata = {
  title: "CMDA & DTCP Approved Plots for Sale in Chennai | Resale Land",
  description:
    "Explore top resale residential plots in Katrambakkam, Nandhambakkam, and Thaiyur (OMR). Verified CMDA & DTCP-approved land with 100% legal clearance.",
  alternates: {
    canonical: "https://www.sribalajihomes.in/properties",
  },
  openGraph: {
...
const locations = [
  {
    title: "DTCP Approved Plots in Katrambakkam",
    linkTitle: "DTCP Approved Resale Plots in Katrambakkam",
    slug: "approved-resale-plots-kattrambakkam-chennai",
    image: "/assets/home/dtcp-approved-resale-plot-kattrambakkam-aerial.webp",
    alt: "DTCP approved resale plot in Katrambakkam Chennai – Sri Balaji Homes",
    anchorText: "Explore Katrambakkam Plots",
    desc: "CMDA & DTCP approved plots near Sriperumbudur industrial corridor with clear title documentation.",
  },
  {
    title: "CMDA Approved Plots in Nandhambakkam",
    linkTitle: "CMDA Approved Plots in Nandhambakkam",
    ...
    image: "/assets/home/cmda-plot-nandhambakkam-road-view.webp",
    alt: "CMDA approved resale plot in Nandhambakkam Chennai – Sri Balaji Homes",
    anchorText: "Explore Nandhambakkam Plots",
    desc: "Ready-to-build approved plots in a rapidly growing Kundrathur-Nandambakkam residential hub.",
  },
  {
    title: "Resale Plots in Thaiyur (OMR)",
    linkTitle: "Residential Resale Plots in Thaiyur, OMR",
    ...
    image: "/assets/home/thaiyur-omr-residential-plot-sale.webp",
    alt: "DTCP approved resale plot in Thaiyur OMR Chennai – Sri Balaji Homes",
    anchorText: "Explore Thaiyur OMR Plots",
    desc: "Prime investment and gated community land along the IT corridor near Siruseri & Kelambakkam.",
  },
];
...
export default function PropertiesHubPage() {
  return (
    <main className="container mx-auto px-6 pt-36 pb-16">
      ...
      <p className="text-gray-600 text-center mb-10 max-w-2xl mx-auto">
        Browse handpicked CMDA and DTCP approved resale plot locations with clear title deeds and zero brokerage.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {locations.map((item) => (
          <div
            key={item.slug}
            className="border rounded-xl overflow-hidden shadow-md bg-white flex flex-col justify-between"
          >
            <div className="relative h-48 w-full">
              <Image
                src={item.image}
