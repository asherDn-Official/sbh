...
export default function ContactPageClient() {
  ...
  return (
    <section className="pt-20 md:pt-30 lg:pt-30 bg-gradient-to-b from-white to-gray-50">
      {/* Heading */}
      <div className="lg:px-20">
        <div className="text-center px-4 mb-16">
          <h1 className="text-4xl font-serif font-semibold mb-4 text-gray-900">
            Contact Us
          </h1>
          <p className="text-gray-600 max-w-2xl mx-auto text-lg">
            Have questions or ready to invest? Contact Sri Balaji Homes for
          ...
          <div className="space-y-10 flex flex-col h-full pt-20 lg:pl-20">
            ...
            <div className="flex items-center justify-center gap-5 mx-auto">
              <div className="flex items-center justify-center space-x-4">
                <Link
                  href="https://www.facebook.com/share/1BUtDYePcK/?mibextid=wwXIfr"
                  className="p-2 text-gray-700 hover:text-green-700 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-600 rounded-full"
            ...
            <form className="space-y-5" onSubmit={handleSubmit} noValidate>
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 bg-gray-50 rounded-lg focus-visible:ring-2 focus-visible:ring-green-600 focus-visible:border-green-600 outline-none transition ${
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 bg-gray-50 rounded-lg focus-visible:ring-2 focus-visible:ring-green-600 focus-visible:border-green-600 outline-none transition ${
                    errors.mobile ? "border border-red-500 ring-1 ring-red-500" : ""
                  }`}
                />
                {errors.mobile && (
                  <p className="text-red-500 text-sm mt-1">{errors.mobile}</p>
              ...
              <div>
                ...
                <textarea
                  ...
                  className={`w-full px-4 py-3 bg-gray-50 rounded-lg focus-visible:ring-2 focus-visible:ring-green-600 focus-visible:border-green-600 outline-none transition ${
                    errors.message ? "border border-red-500 ring-1 ring-red-500" : ""
                  }`}
                ></textarea>
                {errors.message && (
                  <p className="text-red-500 text-sm mt-1">{errors.message}</p>
              ...
              <button
                type="submit"
                disabled={isSubmitting}
                className="w-40 bg-green-700 text-white py-3 rounded-lg font-medium shadow-md hover:bg-green-800 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-green-800 transition-all disabled:bg-gray-400"
              >
                {isSubmitting ? "Sending..." : "Send Message"}
              </button>
              ...
              {/* Status Messages */}
              {submitStatus === "success" && (
                <p className="text-green-600 mt-4 font-medium" role="status" aria-live="polite">
                  Thank you! Your message has been sent successfully.
                </p>
              )}
              {submitStatus === "error" && (
                <p className="text-red-600 mt-4 font-medium" role="status" aria-live="polite">
                  Sorry, something went wrong. Please check your details or try again later.
                </p>
              )}
            </form>
          </div>
      ...
      <div className="mt-20">
        <iframe
          title="Sri Balaji Homes Office Location Map"
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3887.8414762254033!2d80.0295029!3d12.9819891!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a528bb7a16ae543%3A0x10ae9addafa574fd!2sSRI%20BALAJI%20HOMES!5e0!3m2!1sen!2sin!4v1760514644539!5m2!1sen!2sin"
          width="600"
          height="450"
          style={{ border: 0 }}
