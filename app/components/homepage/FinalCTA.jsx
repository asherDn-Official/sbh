...
export default function FinalCTA() {
  return (
    <section
      id="contact"
      className="w-full bg-white pt-16 pb-12 px-4 sm:px-6 lg:px-8 border-b border-slate-200"
    >
      <div className="max-w-6xl mx-auto space-y-16">
        {/* Conversion Banner */}
        <div className="relative rounded-3xl bg-gradient-to-br from-slate-950 via-slate-900 to-[#024b12] p-8 sm:p-12 lg:p-16 text-white overflow-hidden shadow-2xl border border-slate-800">
          ...
          <div className="relative z-10 max-w-3xl mx-auto text-center space-y-6">
            ...
            <p className="text-sm sm:text-lg text-slate-300 leading-relaxed">
              Inspect physical boundaries, access roads, surrounding
              infrastructure, and verify original planning documents with our
              team.
            </p>
        ...
        <div className="border-t border-slate-200 pt-12 grid grid-cols-2 md:grid-cols-5 gap-8 text-xs text-slate-600">
          <div className="space-y-3">
            <h4 className="font-extrabold text-slate-900 text-sm font-serif uppercase tracking-wider">
              Popular Hubs
            </h4>
            <ul className="space-y-2 font-medium">
              <li>
                <Link href="#contact" className="hover:text-[#024b12] transition">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 font-medium">
              ...
              <li>
                <Link href="#contact" className="hover:text-[#024b12] transition">
                  Plots 30 to 50 Lakhs
                </Link>
              </li>
              <li>
                <Link href="#contact" className="hover:text-[#024b12] transition">
                  Plots 50 to 75 Lakhs
                </Link>
              </li>
              <li>
                <Link href="#contact" className="hover:text-[#024b12] transition">
                  Plots Above 75 Lakhs
                </Link>
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 font-medium">
              <li>
                <Link href="/about-us" className="hover:text-[#024b12] transition">
                  About Us
                </Link>
              </li>
              <li>
                <Link href="#contact" className="hover:text-[#024b12] transition">
                  Why Sri Balaji Homes
                </Link>
              </li>
              <li>
                <Link href="/testimonials" className="hover:text-[#024b12] transition">
                  Testimonials
                </Link>
              </li>
              <li>
                <Link href="/contact-us" className="hover:text-[#024b12] transition">
                  Contact Us
                </Link>
              </li>
            </ul>
