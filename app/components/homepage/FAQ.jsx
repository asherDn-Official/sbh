...
export const faqs = [
  ...
  {
    q: "Can I get a bank loan to purchase a residential plot, and what is the financing limit?",
...
export default function FAQ() {
  ...
  // Structured Schema for FAQ Rich Snippets (Task 18)
  const faqSchema = {
    "@context": "https://schema.org",
    "@type": "FAQPage",
    mainEntity: faqs.map((faq) => ({
