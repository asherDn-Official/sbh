    ...
    <>
      ...
      >
        ...
        >
          ...
          <div className="flex items-center gap-2">
            <MdEmail />
            <a href="mailto:info.sribalajihomes@gmail.com">
      ...
      >
        ...
        <div className="hidden md:flex p-3 font-poppins text-white rounded-full bg-[#024b12]">
          ...
          <div ref={dropdownRef} className="relative">
            ...
            {dropdownOpen && (
              <div className="absolute left-0 mt-2 bg-[#023a0d] rounded-2xl shadow-lg py-2 w-52">
                <Link
                  href="/properties"
                  onClick={() => setDropdownOpen(false)}
                  className="block px-4 py-2 text-[#91eda5] font-semibold border-b border-green-900 hover:bg-[#024b12]"
                >
                  All Properties Hub →
                </Link>
                <Link
          ...
          <div className="w-full flex flex-col items-start">
            ...
            {mobileDropdownOpen && (
              <div className="flex flex-col items-start w-56 bg-white border border-gray-200 rounded-xl shadow-lg overflow-hidden">
                <Link
                  href="/properties"
                  className="w-full text-start px-4 py-3 text-[#024b12] font-bold bg-green-50 border-b border-gray-200 hover:bg-[#024b12] hover:text-white transition-colors duration-300"
                  onClick={() => {
                    setMenuOpen(false);
                    setMobileDropdownOpen(false);
                  }}
